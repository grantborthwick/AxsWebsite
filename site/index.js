...
(function($, ko){
    ...
    (function initializeOfficers(){
        /* Initialize Officers */var a=function(position,name,email,picture,classification,major){return new Officer(position,name,email,picture,classification,major);};viewModel.officerList.push(a('Master Alchemist','Patrick Gillespie','patrickj115@ksu.edu','images/officers/Patrick_Gillespie.jpg','Junior','Chemistry'),a('Vice Master Alchemist','Karter Krokstrom ','kkrokstrom@ksu.edu','','Junior','Chemical Engineering'),a('Master of Ceremonies','Emily Wedeman','ewedeman@k-state.edu','images/officers/Emily_Wedeman.jpg','Junior','Chemical Engineering'),a('Outreach Coordinator','Lacey Beck','laceybeck2013@ksu.edu','images/officers/Lacey_Beck.jpg','Senior','Chemistry'),a('Assistant Outreach Coordinator','Muriel Eaton','meaton02@ksu.edu','images/officers/Muriel_Eaton.jpg','Senior','Biochemistry'),a('Social Chair','Marquix Adamson','marquix@ksu.edu','images/officers/Marquix_Adamson.jpg','Junior','Chemistry'),a('Recorder','Stephanie Lee ','stephlee24@ksu.edu ','images/officers/Sarah_Price.jpg','Senior','Chemical Science and Animal Bioscience'),a('Treasurer','Courtney Hess ','chess25@ksu.edu ','','Senior','Chemical Science and Animal Bioscience'),a('Historian','Sydney Masters','smasters@ksu.edu','images/officers/Sydney_Masters.jpg','Sophomore','Life Sciences, Pre-Optometry Major'),a('Reporter','Gabrielle Ciccarelli ','grciccar@ksu.edu','images/officers/Gabrielle_Ciccarelli.jpg','Sophomore','Nutritional Science'),a('Webmaster','Vladislav Dubrovenski','vladi@ksu.edu','images/officers/Vladislav_Dubrovenski.jpg','Junior','Computer Science'),a('Alumni Secretary','Dustin Nelsen ','dnelsen@ksu.edu','','Junior'),a('Chapter Advisor','Emery Brown','emerybrown@ksu.edu','images/officers/Emery_Brown.jpg','Graduate Student','Analytical Chemistry'));/* End Initialize Officers */
    })();

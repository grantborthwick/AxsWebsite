...
(function($, ko){
    ...
    (function createViewModels(){
        ...
        ViewModel = function(){
            ...
            var self = this;
            self.lastUpdated = /* Initialize Today */new Date('11/30/2017 23:36:17');/* End Initialize Today */
            self.officerList = [];
            self.memberList = [];
    ...
    (function initializeOfficers(){
        ...
        /* Initialize Officers */viewModel.officerList.push(
...
new Officer('Chapter Advisor', 'Emery Brown', 'emerybrown@ksu.edu', 'images/officers/Emery_Brown.jpg', 'Graduate Student', 'Analytical Chemistry', ''));/* End Initialize Officers */
    })();

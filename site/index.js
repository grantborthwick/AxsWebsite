...
(function($, ko){
    ...
    (function createViewModels(){
        ...
        ViewModel = function(){
            ...
            var self = this;
            self.lastUpdated = /* Initialize Today */new Date('02/13/2017 13:15:00');/* End Initialize Today */
            self.officerList = [];
            self.memberList = [];
